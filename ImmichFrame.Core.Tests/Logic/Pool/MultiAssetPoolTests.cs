...
namespace ImmichFrame.Core.Tests.Logic.Pool
{
    ...
    public class MultiAssetPoolTests
    {
        ...
        private AssetResponseDto CreateAsset(string id) => new AssetResponseDto { Id = TestIds.From(id), OriginalPath = $"/path/{id}.jpg", Type = AssetTypeEnum.IMAGE, ExifInfo = new ExifResponseDto() };
